...
- **Shows all countries flags and numerical information**
- **Allows a user to search the country using region**
- **Shows details data about the country information**
...
```sh
  cd Rest-Countries
  git clone https://github.com/Paul-tes/Rest-Countries.git
```
-
...
- [ ] **The design will be also for desktop application**
- [ ] **More data information**
- [ ] **Will include the land mark of the country**
...
If you like this project give me a ⭐️ please.
